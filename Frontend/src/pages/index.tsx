            ...
            <div className="min-h-[100vh] sm:min-h-screen w-screen flex flex-col relative bg-[#1d0148] font-inter overflow-hidden">
                ...
                <main className="flex flex-col justify-center h-[90%] static md:fixed w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-[100] pt-[30px] pb-[320px] px-4 md:px-20 md:py-0">
                    ...
                    <div className="flex gap-[15px] mt-8 md:mt-0">
                        ...
                        >
                            <Link
                                href="https://github.com/raoanmol/SunHacks23"
                                target="_blank"
                                className="group rounded-full pl-[8px] min-w-[180px] pr-4 py-2 text-[13px] font-semibold transition-all flex items-center justify-center bg-[#1d0148] text-white hover:bg-[#8d64e4] hover:shadow-lg no-underline flex gap-x-2 active:scale-95 scale-100 duration-75"
                                style={{
                                    boxShadow:
                                        "0px 1px 4px rgba(13, 34, 71, 0.17), inset 0px 0px 0px 1px #24cee0, inset 0px 0px 0px 2px rgba(88, 248, 255, 0.1)",
                                }}
                            >
                                <span className="w-5 h-5 rounded-full bg-[#88f8ff] flex items-center justify-center">
                                    <svg
                                        className="w-[16px] h-[16px] text-[#015b7a]"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                    >
                                        <path
                ...
                ></motion.canvas>
                <div className="h-[60px] bg-[#1d0148] text-[#a98efe] fixed bottom-0 z-20 w-3/4 flex flex-row items-center justify-evenly">
                    <p className="text-[#a98efe] text-base md:text-lg font-semibold md:leading-[60px] whitespace-nowrap flex flex-row">
                        Developed by
                    </p>

                    <p>
                        <a href="https://www.linkedin.com/in/chai-t/" target="_blank" rel="noopener noreferrer">Chaitanya Chaurasia</a>
                    </p>
                    <p>
                        <a href="https://gholtzap.github.io/" target="_blank" rel="noopener noreferrer">Gavin Holtzapple</a>
                    </p>
                    <p>
                        <a href="https://www.linkedin.com/in/anmol-rao/" target="_blank" rel="noopener noreferrer">Anmol Rao</a>
                    </p>
                    <p>
