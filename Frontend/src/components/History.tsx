...
import { Box, Text, VStack, Icon, Heading } from "@chakra-ui/react";
...
const chatMessages = [
  ...
  {
    id: 9,
    content: "Identifying Hidden Fees in a Subscription Service Contract",
  },
  ...
  {
    id: 15,
    content: "Investigating a Vendor Agreement for Hidden Obligations",
  },
];
